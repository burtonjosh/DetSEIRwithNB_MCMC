...
global regions = ["EN", "EE", "LO", "MI", "NE", "NW", "SE", "SW", "UK"]; #["NI", "SW"];
for region in regions
  ...
  if region == "EE"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,1:4]
  ...
  elseif region == "LO"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,5:8]
    # data = readdlm("datafit_EN.csv",',')[:,1:3];
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
  ...
  elseif region == "MI"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,9:12]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "NE"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,13:16];
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "NW"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,17:20]
    # data = readdlm("datafit_EN.csv",',')[:,1:3];
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
  ...
  elseif region == "SE"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,21:24]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "SW"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,25:28]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "EN"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,29:32]
    # data = readdlm("datafit_EN.csv",',')[:,1:3];
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
  ...
  elseif region == "SC"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,33:36]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "WA"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,37:40]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "NI"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,41:44]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  elseif region == "UK"
    # set data
    data = readdlm("all_data_to_export_first_half.csv",',')[:,45:48]
    global hospital_incidence_data  = [data[i,1] for i in 1:length(data[:,1]) if isnan.(data[i,1])==0][1:end-2]; #data[:,1];
    global hospital_prevalence_data = [data[i,2] for i in 1:length(data[:,2]) if isnan.(data[i,2])==0];# data[:,2];
    global icu_prevalence_data      = [data[i,3] for i in 1:length(data[:,3]) if isnan.(data[i,3])==0];# data[:,3];
    global death_data               = [data[i,4] for i in 1:length(data[:,4]) if isnan.(data[i,4])==0][1:end-5];# data[:,4];
  ...
  posterior_samples = random_walk(delayed_ode,
                                  ...
                                  covariance_matrix,
                                  1)
  writedlm(string("$region","_output_first_half.csv"),posterior_samples,',')

  # do this once you have a covariance matrix for decent posteriors
  output = readdlm(string("$region","_output_first_half.csv"),',');
  ...
  chain = Chains(posterior_samples,["β₁","β₂","β₃","β₄","log(J₀)","σ_hi","σ_hp",
                                    "σ_up","σ_di","pC","pT","pD"]);
  savefig(plot(chain),string("$region","_chain_first_half.png"))

  # make predictions
  # posterior_samples = readdlm(string("$region","_output_first_half.csv"),',');
